---
id: first-way-motion
title: "The First Way: the argument from motion"
summary: From the reality of change to an Unmoved Mover.
audiences:
  - atheist
  - agnostic
branches:
  - to: contingency-necessity
    label: "Compare with the argument from contingency"
  - to: why-jesus
    label: "Grant a First Cause — why Jesus?"
...
1. Some things are in motion — that is, they change from potential to actual.
