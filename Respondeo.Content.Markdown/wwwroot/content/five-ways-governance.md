...
> Whatever lacks knowledge cannot move towards an end, unless it be directed by some being endowed with knowledge and intelligence, as the arrow is directed by the archer.
...
3. An arrow does not aim itself; it is aimed. So too the reliable striving of mindless nature must be directed by an intellect.
...
**A clarification.** This is not the modern "argument from design" that points to complexity and infers a tinkering engineer. 
Aquinas points to something more basic and harder to escape: the plain fact that unknowing things are *directed at all* &mdash; that causes reliably point toward specific effects rather than nothing in particular. 
Even the regularities physics depends on are instances of this directedness.

## See it today: a plant on the windowsill

Watch a houseplant for a week and you will see the Fifth Way unfold &mdash; not as a story about the distant past, but as directedness happening *now*.

Consider everything the plant does, none of which it *understands*:
...
An arrow flies true because an archer aimed it. The plant "reaches" for the light because its nature is aimed &mdash; and a nature aimed without a mind of its own points beyond itself to a **directing intelligence**.
