...
summary: The Thomistic starting point — demonstrating God from what we observe.
audiences:
  - atheist
  - agnostic
...
branches:
  - to: first-way-motion
    label: "The argument from motion (change)"
    prompt: Aquinas's First Way — the most manifest path.
