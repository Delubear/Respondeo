...
// Prologue clean-up: trimming the enumerated article list that duplicates the on-page table of
// contents while preserving the lead-in sentence and every other prologue paragraph.
