...
/// Consumers call <see cref="AddRespondeoContent"/> and depend only on <see cref="IContentService"/>; the parser and service implementations stay internal.
/// </summary>
public static class ServiceCollectionExtensions
{
    /// <summary>
    /// Registers the content parser and the <see cref="IContentService"/> implementation.
    /// The service is scoped because it depends on the scoped <see cref="HttpClient"/> in Blazor WebAssembly; the parser is stateless and registered as a singleton.
    /// </summary>
