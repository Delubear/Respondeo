...
2. God exists.
3. So God needs a cause &mdash; and then that cause needs a cause, forever.
4. Either everything has a cause (so God is not special), or something can be uncaused (so why not the universe?).
